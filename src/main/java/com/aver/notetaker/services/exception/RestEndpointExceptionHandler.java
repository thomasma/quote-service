...
//    protected final static Logger LOGGER = LoggerFactory.getLogger(RestEndpointExceptionHandler.class);
//
//    @Autowired
...
//                resolvedErrs.add(resolveLocalizedErrorMessage(errorBean.getCode(), errorBean.getParams()));
//            }
//            errors.clear();
...
//            errors.addAll(resolveErrorMessages(ex.getFieldErrors().getAllErrors()));
//        }
//
...
//            try {
//                localizedErrorMessage = messageSource.getMessage(fieldError, LocaleContextHolder.getLocale());
...
//            }
//            errors.add(new ErrorBean(fieldError.getCode(), localizedErrorMessage));
//        }
//        return errors;
//    }
//
...
//     * @return
//     */
//    private ErrorBean resolveLocalizedErrorMessage(final String code, final Object[] params) {
//        try {
//            return new ErrorBean(code, messageSource.getMessage(code, (params != null ? params : new Object[] {}),
